    ...
    <div class="layui-card">
        <div class="layui-card-body">
            <div style="padding-bottom: 10px;">
                <button class="layui-btn layuiadmin-btn-list type-add">添加</button>
            </div>
            <div>
...
<div style="display: none" id="type-form">
    <div class="layui-form" lay-filter="type-form" style="padding: 20px 30px 0 0;">
        ...
        <div class="layui-form-item layui-hide">
            <input type="button" lay-submit lay-filter="type-form-submit" id="type-form-submit" value="确认">
        </div>
    </div>
</div>
...
<script>
    layui.use(['jquery','table','form'], function() {
        ...
        var type_table_ajax_url = '{{url("admin/book/book_type_list")}}';
        var type_del_url        = '{{url("admin/book/book_type_del")}}';
        var type_save_url       = '{{url("admin/book/book_type_save")}}';

        // 数据表格渲染
        table.render({
            elem: '#type_table'
            ,url: type_table_ajax_url //数据接口
            ,method:'post'
//            ,height: 'full-100'
            ,page: false //开启分页
            ,limit:20  //每页行数 默认10
        ...
        // 编辑和删除操作
        table.on('tool(type_table)', function(obj)
        {
            var data = obj.data;
