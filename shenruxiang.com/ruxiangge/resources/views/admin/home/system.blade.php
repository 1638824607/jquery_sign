...
<head>
    ...
    <title><?php echo I18nApi::_(Config::$APP_NAME); ?><?php echo Config::$APP_VERSION; ?></title>
    <?php Events::emit('style'); ?>
</head>
<body>
<div class="poi-container">
    <h1><a  href="javascript:void 0"><?php echo I18nApi::_(Config::$APP_NAME); ?><?php echo Config::$APP_VERSION; ?></a></h1>
...
var lang = '{$this->_('{APP_NAME}{APP_NEW_VERSION}')}';
...
<a href="<?php echo I18nApi::_(Config::$APP_URL); ?>" target="_blank">
</a>
<div class="poi-container">
    <div class="footer">
