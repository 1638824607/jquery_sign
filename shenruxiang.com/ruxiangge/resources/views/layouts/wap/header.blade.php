...
<div class="newwap">
    <div class="readhd bg  clearfix">
        <div class="container index  clearfix">
            <span class="fl left">
                <a href="{{url('/')}}" class="logo" title="入香阁">
            ...
            <span class="fr right">
                @guest('wap')
                    ...
                    <a href="{{url('book_collect_list')}}" class="mbook">书架</a>
                    <a href="{{url('inside_search')}}" class="msearch">搜索</a>
                @else
                    <a href="{{url('user')}}" class="xhome">
    ...
    <div class="indexmenu bg clearfix ">
        <div class="mnx clearfix">
            <ul class="clearfix ">
                <li class="@if(mca()['action'] == 'index') active @endif"><a href="{{url('/')}}">精选</a></li>
                <li class="@if(mca()['action'] == 'book_rank') active @endif"><a href="{{url('book_rank')}}">排行</a></li>
                <li class="@if(mca()['action'] == 'book_boy') active @endif"><a href="{{url('book_boy')}}">男生</a></li>
                <li class="@if(mca()['action'] == 'book_girl') active @endif"><a href="{{url('book_girl')}}">女生</a></li>
                <li class="@if(in_array(mca()['action'], ['book_category', 'book_list'])) active @endif"><a href="{{url('book_category')}}">分类</a></li>
                <li class="@if(mca()['action'] == 'book_recommend' || mca()['action'] == 'book_recommend_list') active @endif"><a href="{{url('book_recommend')}}">推荐</a></li>
            </ul>
        </div>
    </div>
    <a href="{{url('poly/book_list')}}" class="footer-backtop-circle ">
        <span class="btn-primary-circle">全网</span>
    </a>
