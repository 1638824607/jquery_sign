...
@section('content')
    ...
    <div class="newbanner clearfix">
        <div class="insearch">
            ...
            <div class="modelx shuangwen bg clearfix">
                <div class="container">
                    <h2 class="boy1">热血爽文</h2>
                    @foreach($bookManRow2 as $bookRow)
                        @if($loop->iteration < 4)
                            <div class="rowone clearfix">
                                <a href="{{url('book_detail/'.$bookRow['id'])}}">
                                    <div class="fl rleft">
            ...
            <div class="modelx boytop bg clearfix">
                <div class="container">
                    ...
                    <div class="rowlist">
                        <div class="rowx">
                            @foreach($bookManReadDayRankList as $bookRow)
                                @if($loop->iteration < 6)
    ...
    <script>
        $('#metakeywords').attr('content', "男生,"+$('#metakeywords').attr('content'));
    </script>
@endsection