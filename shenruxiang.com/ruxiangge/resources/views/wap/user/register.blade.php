    ...
    <div class="loginreg bg clearfix" style="top: -10%;">
        <div class="container">
            ...
            <ul>
                ...
                {{--</li>--}}
                <li>
                    <input class="passwdx" placeholder="请输入8-16位密码" type="password">
                </li>
                <li>
                    <input class="passwdx username" placeholder="请输入昵称" type="text">
                </li>
            </ul>
            <div class="btnx">
...
//        var yzmx = $('.loginreg .yzmx').val().trim();
        ...
        var username = $('.loginreg .username').val().trim();
...
//        }
        ...
        if(passwdx.length < 8 || passwdx.length > 16) {
            layer.open({
                content: '请输入8-16位密码'
                ,skin: 'msg'
                ,time: 1
        ...
        $.ajax({
            ...
            cache:false,
            data:{
                reg_user_email:emails,
//                reg_user_email_verify:yzmx,
                reg_user_name:username,
                reg_user_pass:passwdx
            },
            success:function(data){
                layer.open({
                    content: data.msg
