    ...
    <div class="aboutme bg clearfix">
        <div class="container">
            <ul>
                ...
                <li class="history"><a href="{{url((mca()['controller'] == 'Poly' ? 'poly/' : '') .'book_history')}}" title="">阅读历史</a></li>
                <li class="book"><a href="{{url((mca()['controller'] == 'Poly' ? 'poly/' : '').'book_collect_list')}}" title="">我的书架</a></li>
